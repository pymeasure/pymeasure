...
For ease of use, we have :ref:`property creators <properties>` to create easily python properties. Similarly, we have creators to implement easily :ref:`channels <channels>`. Finally, for a smoother implementation process and better maintenance, we have :ref:`tests <tests>`.
